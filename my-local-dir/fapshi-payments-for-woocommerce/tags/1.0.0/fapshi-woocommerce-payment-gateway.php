...
function fapshi_init_gateway_class() {
	...
	class WC_Fapshi_Gateway extends WC_Payment_Gateway {
        ...
        add_action( 'woocommerce_api_wc_fapshi_gateway', array( $this, 'webhook' ) );
      }
 		...
 		public function init_form_fields(){
			...
			$this->form_fields = array(
                ...
                'webhook' => array(
                    ...
                    'description' => __( 'Please copy this webhook URL and paste on the webhook section on your dashboard <strong style="color: red"><pre><code>'.WC()->api_request_url('WC_FAPSHI_GATEWAY').'</code></pre></strong> (<a href="https://dashboard.fapshi.com/" target="_blank">Fapshi Account</a>)', 'woo-fapshi-payment' ),
                ),
                'card' => array(
